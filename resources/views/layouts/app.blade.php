...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased bg-slate-100" x-data="{ sidebarOpen: false }">
        <div class="min-h-screen">
            ...
            <!-- Sidebar -->
            <aside class="fixed inset-y-0 left-0 z-40 w-64 bg-gradient-to-b from-brand-900 via-brand-900 to-brand-950 text-brand-100 flex flex-col transform transition-transform duration-200 lg:translate-x-0"
                ...
                <nav class="flex-1 overflow-y-auto px-3 py-4 space-y-6">
                    <div>
                        <p class="px-3 mb-2 text-[11px] font-semibold uppercase tracking-wider text-brand-300/70">Main</p>
                    ...
                    <div>
                        <p class="px-3 mb-2 text-[11px] font-semibold uppercase tracking-wider text-brand-300/70">Operations</p>
                ...
                <!-- Sidebar footer -->
                <div class="px-5 py-4 border-t border-white/10 text-[11px] text-brand-300/60 shrink-0">
            ...
            <div class="lg:pl-64 flex flex-col min-h-screen">
                ...
                <!-- Topbar -->
                <header class="sticky top-0 z-20 h-16 bg-white/90 backdrop-blur border-b border-slate-200 flex items-center gap-4 px-4 sm:px-6">
                    <button class="lg:hidden text-brand-800" @click="sidebarOpen = true">
                    ...
                    <div class="ml-auto flex items-center gap-3">
                        ...
                        <div class="relative" x-data="{ open: false }">
                            <button @click="open = !open" class="flex items-center gap-3 rounded-lg px-2 py-1.5 hover:bg-slate-100">
                                <span class="grid h-9 w-9 place-items-center rounded-full bg-gradient-to-br from-brand-600 to-accent-500 text-sm font-bold text-white">
