<x-app-layout>
    ...
    <x-slot name="header">
        <div class="flex flex-wrap items-center justify-between gap-4">
            <div>
                <h2 class="text-2xl font-bold text-brand-900">Sites</h2>
                <p class="text-sm text-slate-500 mt-0.5">Branches, warehouses, outlets and other business locations</p>
            </div>
            @can('sites.create')
    ...
    <div class="rounded-2xl bg-white shadow-sm ring-1 ring-slate-200 overflow-hidden">
        ...
        <table class="w-full min-w-[720px] text-sm">
            ...
            <tbody class="divide-y divide-slate-100">
                ...
                <tr class="hover:bg-slate-50">
                    ...
                    <td class="px-5 py-3">
                        <div class="flex items-center justify-end gap-1">
                            @can('sites.edit')
                            <a href="{{ route('sites.edit', $site) }}" title="Edit"
                ...
                @empty
                <tr>
                    <td colspan="6" class="px-5 py-10 text-center text-slate-400">No sites yet — add your first branch, warehouse or outlet.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
