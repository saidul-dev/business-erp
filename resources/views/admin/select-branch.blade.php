<x-guest-layout>
    <div class="mb-5 text-center">
        <h2 class="text-xl font-bold text-brand-900">{{ __('Select a Branch') }}</h2>
        <p class="mt-1 text-sm text-slate-500">{{ __("You're assigned to more than one branch. Pick which one you're working from.") }}</p>
    </div>
