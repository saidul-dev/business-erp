<x-app-layout>
    ...
    <x-slot name="header">
        <div class="flex flex-wrap items-center justify-between gap-4">
            <div>
                <h2 class="text-2xl font-bold text-brand-900">Products</h2>
                <p class="text-sm text-slate-500 mt-0.5">Product catalogue — global master data, not tied to a specific site</p>
            </div>
    ...
    <form method="GET" action="{{ route('products.index') }}" class="mb-4 max-w-md">
        <div class="relative">
            ...
            <input type="search" name="q" value="{{ request('q') }}" placeholder="Search by name, SKU or barcode…"
