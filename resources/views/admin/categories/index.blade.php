<x-app-layout>
    ...
    <x-slot name="header">
        <div class="flex flex-wrap items-center justify-between gap-4">
            <div>
                <h2 class="text-2xl font-bold text-brand-900">Categories</h2>
                <p class="text-sm text-slate-500 mt-0.5">Product categories, optionally nested under a parent</p>
            </div>
        ...
        <table class="w-full min-w-[680px] text-sm">
            <thead>
                <tr class="border-b border-slate-100 bg-slate-50 text-left text-xs uppercase tracking-wide text-slate-500">
                    ...
                    <th class="px-5 py-3 font-semibold">Sub-categories</th>
            ...
            <tbody class="divide-y divide-slate-100">
                ...
                @empty
                <tr>
                    <td colspan="6" class="px-5 py-10 text-center text-slate-400">No categories yet — add your first product category.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
