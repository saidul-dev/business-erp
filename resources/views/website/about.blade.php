<x-website-layout :title="__('About')">
    ...
    <section class="bg-white py-20 sm:py-28">
        <div class="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 text-center">
            ...
            <h2 class="mt-6 text-2xl sm:text-3xl font-extrabold text-brand-950 tracking-tight">{{ __('Our Story') }}</h2>
            <p class="mt-5 text-lg leading-relaxed text-slate-600">
                {{ $company->about_text ?: __('Details about our business will appear here once added in Admin > Settings > Website Settings.') }}
            </p>
        </div>
    </section>
    ...
    <section class="bg-slate-50 py-20 sm:py-28">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="text-center max-w-2xl mx-auto">
                <p class="text-sm font-semibold text-accent-600 tracking-wide uppercase">{{ __('Registered & Verified') }}</p>
