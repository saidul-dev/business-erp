<x-website-layout :title="'Shop'">
    ...
    <section class="bg-gradient-to-br from-brand-950 via-brand-900 to-brand-800 py-20 text-center">
        <div class="mx-auto max-w-3xl px-4">
            ...
            <p class="mt-4 text-brand-200/90">Our product catalogue is being set up — check back soon.</p>
        </div>
    </section>
            ...
            @for ($i = 0; $i < 8; $i++)
                <div class="rounded-2xl border border-slate-200 overflow-hidden">
                    ...
                    <div class="p-4">
                        ...
                        <p class="mt-1 text-sm text-slate-400">Product listing placeholder</p>
                    </div>
                </div>
            @endfor
        </div>
