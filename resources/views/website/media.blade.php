<x-website-layout :title="'Media'">
    ...
    <section class="bg-gradient-to-br from-brand-950 via-brand-900 to-brand-800 py-20 text-center">
        <div class="mx-auto max-w-3xl px-4">
            ...
            <h1 class="mt-6 text-4xl font-extrabold text-white">Photos &amp; Press</h1>
            <p class="mt-4 text-brand-200/90">A look at our shop, products and team — updated regularly.</p>
        </div>
    </section>
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            @for ($i = 0; $i < 8; $i++)
                <div class="rounded-2xl border border-slate-200 overflow-hidden">
                    ...
                    <div class="p-4">
                        <p class="font-semibold text-brand-950">Coming soon</p>
                        <p class="mt-1 text-sm text-slate-400">Gallery placeholder</p>
                    </div>
                </div>
            @endfor
        </div>
