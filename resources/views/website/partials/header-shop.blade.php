    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex h-16 items-center gap-4">
            ...
            <div class="flex items-center gap-1 shrink-0 ml-auto">
                <a href="javascript:void(0)" title="Wishlist — coming soon" class="relative rounded-lg p-2 text-white/70 hover:bg-white/10 hover:text-white">
                ...
                <a href="javascript:void(0)" title="Compare — coming soon" class="relative rounded-lg p-2 text-white/70 hover:bg-white/10 hover:text-white">
                ...
                <a href="{{ route('cart') }}" title="Cart" class="relative rounded-lg p-2 text-white hover:bg-white/10">
                ...
                @auth
                <a href="{{ route('dashboard') }}" title="Dashboard" class="rounded-lg p-2 text-white hover:bg-white/10">
                ...
                @else
                <a href="{{ route('login') }}" title="Login" class="rounded-lg p-2 text-white hover:bg-white/10">
                    <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z"/></svg>
                </a>
                @endauth
